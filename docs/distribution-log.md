...
| Flathub | v0.0.9 | **Prepared; not published** | A local Flatpak manifest exists; no public Flathub pull request or listing is recorded. |
| Homebrew | — | **Not prepared** | No formula or tap is present. |

Use **Live** only after opening the public listing while signed out. Use **Pending** only when a submission URL or review record is available. Otherwise keep **Prepared; unverified** or **Not prepared**.
