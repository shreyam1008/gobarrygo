...
| `winget/manifests/s/ShreyamAdhikari/GoBarryGo/0.0.7/` | WinGet manifests |

---

## Step 0: Prepare release artifacts

Before submitting to any store, create a GitHub Release tag `v0.0.7` with:
...
snapcraft
# Produces: gobarrygo_0.0.7_amd64.snap
```
...
snapcraft upload gobarrygo_0.0.7_amd64.snap --release=stable
```
...
```bash
git ls-remote https://github.com/shreyam1008/gobarrygo refs/tags/v0.0.7
...
2. Copy `packaging/winget/manifests/s/ShreyamAdhikari/GoBarryGo/0.0.7/` into your fork
3. Replace placeholder `InstallerSha256` with real sha256
4. Validate:

```powershell
winget validate manifests/s/ShreyamAdhikari/GoBarryGo/0.0.7/
```
